...
function getPosts() {
    _http.http.get('https://microst.vercel.app/posts').then(function (data) {
...
function submitPost() {
    ...
    if (title === "" || body === "") {
        ...
        if (id === '') {
            _http.http.post('https://microst.vercel.app/posts', data).then(function (data) {
            ...
            _http.http.put('https://microst.vercel.app/posts/' + id, data).then(function (data) {
...
function deletePost(e) {
    ...
    if (e.target.parentElement.classList.contains('delete')) {
        ...
        if (confirm('Are you sure?')) {
            _http.http.delete('https://microst.vercel.app/posts/' + id).then(function (data) {
    ...
    _createClass(UI, [{
        ...
        value: function changeFormState(type) {
            if (type === 'edit') {
                ...
                this.postSubmit.className = 'post-submit btn btn btn-warning btn-block';
                ...
                this.postSubmit.className = 'post-submit btn btn btn-primary btn-block';
